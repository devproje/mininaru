...
func annotationPermission(annotations *mcp.ToolAnnotations) Permission {
	if annotations == nil {
...
func parsePermission(value string) (Permission, bool) {
	...
	case "safe":
		return PermissionSafe, true
	case "dangerous":
		return PermissionDangerous, true
	}

	return PermissionDangerous, false
}

func overridePermission(entry *MCPServer, tool string, derived Permission) Permission {
	var value string
	var ok bool
